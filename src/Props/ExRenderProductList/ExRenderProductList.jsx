...
export default class ExRenderProductList extends Component {
  ...
  render() {
    /*
        Props là gì?
        props là thuộc tính có sẵn của react class component dùng để nhận giá trị từ nơi sữ dụng thẻ component này truyền vào (component cha truyền vào)

        Props khác state?
        props và state đều là thuộc tính có sẵn của component để chứa dữ liệu và binding lên giao diện
